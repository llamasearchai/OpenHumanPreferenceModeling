            ...
            <div className="navbar-wrapper">
                <div className="m-header">
                    <Link href="/" className="b-brand">
                        ...
                        <Image width={140} height={30} src="/images/logo-openresearcher-full.svg" alt="Open Researcher" className="logo logo-lg" />
                        <Image width={140} height={30} src="/images/logo-openresearcher-mark.svg" alt="Open Researcher" className="logo logo-sm" />
                    </Link>
                </div>
