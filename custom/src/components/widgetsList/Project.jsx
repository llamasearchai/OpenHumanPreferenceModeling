...
const Project = ({ cardYSpaceClass, borderShow, title, data = projectsData.runningProjects, footerText = "Upcomming Projects", footerHref = "#" }) => {
    ...
    return (
        <div className="col-xxl-4">
            <div className={`card stretch stretch-full ${isExpanded ? "card-expand" : ""} ${refreshKey ? "card-loading" : ""}`}>
                ...
                <Link href={footerHref} className="card-footer fs-11 fw-bold text-uppercase text-center">{footerText}</Link>
            </div>
