...
const SiteOverviewStatistics = ({ data = crmStatisticsData }) => {
    return (
        <>
            {
                data.map(({ id, completed_number, progress, progress_info, title, total_number, icon }) => (
                        ...
                        <div className="card stretch stretch-full short-info-card">
                            <div className="card-body">
                                <div className="d-flex align-items-start justify-content-between mb-4">
                                    ...
                                    <Link href="/modules" className="lh-1">
                                        <FiMoreVertical className='fs-16' />
                                    </Link>
                                </div>
                                <div className="pt-4">
                                    <div className="d-flex align-items-center justify-content-between">
                                        <Link href="/modules" className="fs-12 fw-medium text-muted text-truncate-1-line">{title}</Link>
